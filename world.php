...
if ($lookup == 'cities' && !empty($country)) {
    ...
    if (!empty($results)) {
        ...
        echo "<p class='error-message'>No cities found for the selected country.</p>";
    }
} else {
    ...
    if (empty($country)) {
        ...
        if (!empty($results)) {
            ...
            echo "<p class='error-message'>No countries found.</p>";
        }
    } else {
        ...
        if (!empty($results)) {
            ...
            echo "<p class='error-message'>No countries found matching your search.</p>";
        }
    }
}
?>
